...
//         ) : cartItems.length === 0 ? (
//           // 🛒 Empty Cart Message
//           <h2 className="text-center mt-20 text-xl">🛒 Your cart is empty</h2>
//         ) : (
//           // 💳 Checkout Form + Order Summary
//           <div className="mt-18 max-w-5xl mx-auto p-10">
...
//       {/* 🦶 Sticky Footer */}
//       <footer className="bg-gray-900 text-white text-center mt-auto">
//       </footer>
//     </div>
//   );
// }
...
// import { useCart } from "@/app/context/CartContext";
// import { useState } from "react";
// import Breadcrumbs from "@/app/components/breadcrumbs"; // ⭐ ADDED
...
//       {/* 🦶 Sticky Footer */}
//       <footer className="bg-gray-900 text-white text-center mt-auto"></footer>
//     </div>
//   );
// }
